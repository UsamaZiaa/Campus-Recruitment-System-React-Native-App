    ...
    useEffect(() => {
        ...
        Firebase.auth().onAuthStateChanged(function(user) {
            if (user) {
                ...
                const userData =  Firebase.database().ref('students').child(user.uid);
      ...
      const studentsTasks = [
        {name: 'View Profile',src: require('../../images/user-icon.png'), id: '1', screen: 'ViewStudentProfile'},
        {name: 'View Jobs',src: require('../../images/job-icon.png'), id: '5', screen: 'FindJobs'},
      ]
